...
//                     <p style="margin:5px 0; color:var(--primary); font-weight:600">${job.role}</p>
//                     <small>${job.date} | <span class="status-tag">${job.status}</span></small>
//                 </div>
//                 <div>
...
//     general: ["git", "docker", "aws", "firebase"],
//   };
...
//   const score = Math.min(Math.round((matched.length / 12) * 100), 100);
//   const resultBox = document.getElementById("resultBox");
//   resultBox.classList.remove("hidden");
//   document.getElementById("scoreText").innerText = `ATS Score: ${score}%`;
//   document.getElementById("feedbackText").innerHTML =
//     matched.length > 0
//       ? `<strong>Keywords Found:</strong> ${matched.join(", ")}`
//       : "No matching keywords found. Try adding technical skills!";
// }
...
//       date: "2023-11-05",
//     },
//     { company: "Amazon", role: "SDE-1", status: "Offer", date: "2023-10-20" },
//   ];
//   localStorage.setItem("jobs", JSON.stringify(jobs));
//   displayJobs();
// }
